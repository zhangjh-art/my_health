...
import com.cnasoft.health.common.converter.CustomUserAuthenticationConverter;
...
/**
 * 资源服务器 TokenStore 配置类 JWT RSA 非对称加密
 * <p>
 * 公钥验签
 *
 * @author cnasoft
 * @date 2020/7/2 16:55
 */
@ConditionalOnProperty(prefix = "cnasoft.oauth2.token.store", name = "type", havingValue = "resJwt")
